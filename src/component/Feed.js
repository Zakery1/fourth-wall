...
function Feed() {
  ...
  return (
    <div className="zgFeeds">
        <iframe title="#6: Once Upon a Time in Hollywood, Paths of Glory, 45 Years" src="https://www.podbean.com/media/player/68re9-bb2efc?from=yiiadmin&download=1&version=1&skin=1&btn-skin=112&auto=0&share=1&fonts=Helvetica&download=1&rtl=0&pbad=1" className="stylez" scrolling="yes" data-name="pb-iframe-player"></iframe>
